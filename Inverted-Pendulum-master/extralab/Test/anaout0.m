...
reference = [6.455078125000000; % position
             0.004882812500000;  % velocity
             5.068359375000000;  % angle (the sensor give this value when the pendulum is in the up position)
             0.004882812500000]; % angular velocity
